...
<head>
    ...
    <title>装箱问题 —— AAPL Beijing Council</title>
    ...
    <meta property="og:image" content="https://abcouncil.me/images/open_graph_logo.png">
    <link rel="apple-touch-icon" href="https://abcouncil.me/images/apple-touch-icon.png">
    <link rel="mask-icon" href="https://abcouncil.me/images/mask-icon.svg" color="#333333">
    <link rel="icon" href="https://abcouncil.me/images/favicon.ico">
    <link rel="stylesheet" type="text/css" href="https://abcouncil.me/CSS/style.css">
    <script>
...
<!--            <a class="navItem_menu" href="/about-us" onclick="gtag('event', 'click', {'event_category': 'textLink', 'event_label': 'navBarAboutUs'});">About Us</a>-->
    ...
    <main class="main anibg">
        <section class="section section-join">
            <h1 class="text-center">装箱问题的一种思路</h1>
<!--
...
-->
            ...
            <p class="introduction">　　这是一个临时页面。<br>
　　 <br>
(二) 背景及业务叙述</p>
...
<center>
        <h2>代码下载</h2>
            <div class="call-up">
                <a class="join-button" href="https://github.com/Dylan1st/3D-Packaging-Problem/archive/master.zip">Java 代码下载</a>
<!--                 <span class="comming-soon">需要安装 FastJSON.jar</span> -->
            </div>

            <div class="call-up">
                <a class="join-button" href="https://search.maven.org/remote_content?g=com.alibaba&a=fastjson&v=LATEST">FastJSON.jar 下载</a>
<!--                 <span class="comming-soon">The entrance will be opened later.</span> -->
            </div>
</center>
</div>
    </section>
    ...
    <footer>
        <div class="footer-content">
            ...
            <div class="final">
                ...
                <div class="language">
                    <a href="/cn/404" onclick="gtag('event', 'click', {'event_category': 'textLink', 'event_label': 'footerSwitchToChinese'});">中文</a>
                </div>
            </div>
        </div>
    </footer>
